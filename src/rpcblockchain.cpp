...
Value getrawmempool(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in unattainiumv2s\n"
...
Value gettxout(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of unattainiumv2 addresses\n"
            "        \"unattainiumv2address\"   (string) unattainiumv2 address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
