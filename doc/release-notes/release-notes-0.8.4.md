UnattainiumV2-Qt version 0.8.4 is now available from:
...
code, causing the UnattainiumV2-Qt or unattainiumv2d process to crash.
...
Linux: clicking on unattainiumv2: links was broken if you were using
a Gnome-based desktop.

Fix a hang-at-shutdown bug that only affects users that compile
their own version of UnattainiumV2 against Boost versions 1.50-1.52.
