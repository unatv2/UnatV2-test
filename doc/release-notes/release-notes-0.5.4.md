UnattainiumV2 version 0.5.4 is now available for download at:
...
http://gitorious.org/unattainiumv2/unattainiumv2d-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix UnattainiumV2-Qt notifications under Growl 1.3.
Increase required age of UnattainiumV2-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxUnattainiumV2 properly when installing UnattainiumV2-Qt over it. (Windows)
