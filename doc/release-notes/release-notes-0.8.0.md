UnattainiumV2-Qt version 0.8.0 is now available from:
...
Mac and Windows binaries are signed with certificates owned by the UnattainiumV2
...
New/changed settings (command-line or unattainiumv2.conf file)
--------------------------------------------------------
